...
function check() {
  ...
  if (firstName.value == 0) {
    window.alert("First Name field can not be empty!!");
    firstName.focus();
    return false;
  }
  if (lastName.value == 0) {
    window.alert("Last Name field can not be empty!!");
    lastName.focus();
    return false;
  }
  if (email.value == 0) {
  ...
  if (contact.value == 0) {
    window.alert("Contact Details is Mandatory");
    contact.focus();

    return false;
  }
  if (address.value == 0) {
    window.alert("Address is Mandatory Field!!");
    address.focus();

    return false;
  }
  if (college.value == 0) {
    window.alert("College Name Can not be empty!!");
    college.focus();
  ...
  if (nationality.value == 0) {
    window.alert("Nationality can not be empty!!");
    nationality.focus();
